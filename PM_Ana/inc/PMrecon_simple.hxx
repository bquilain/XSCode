		  ...
		  for(TMP=0;TMP<2;TMP++){
			...
			if(value[VIEW][PLN2-DIST2][neiu[VIEW][PLN2][NEI][DIST2][DIST3]][DIST2]+1==value[VIEW][PLN2+1][neid[VIEW][PLN2][NEI][DIST2][DIST3]][DIST3]||TMP!=0){
			  ...
			  if(
			     ...
			     ||
			     (mod==16&&((chi2/ntracell[VIEW][ntrack[VIEW]]>58&&ntracell[VIEW][ntrack[VIEW]]==1)||			  
					(chi2/ntracell[VIEW][ntrack[VIEW]]>53&&ntracell[VIEW][ntrack[VIEW]]>1)||
					((chi2/ntracell[VIEW][ntrack[VIEW]]-chi2old)>52 -(ntracell[VIEW][ntrack[VIEW]]-1)*0.00)))
			     ){
