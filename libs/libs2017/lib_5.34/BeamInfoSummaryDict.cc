//
// File generated by rootcint at Fri Apr 14 19:13:37 2017

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME BeamInfoSummaryDict
...
namespace ROOT {
   void BeamInfoSummary_ShowMembers(void *obj, TMemberInspector &R__insp);
   ...
   static void streamer_BeamInfoSummary(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BeamInfoSummary*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BeamInfoSummary", ::BeamInfoSummary::Class_Version(), "./../src/BeamInfoSummary.h", 18,
      ...
      instance.SetStreamerFunc(&streamer_BeamInfoSummary);
      return &instance;
   }
...
void BeamInfoSummary::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.ReadStaticArray((double*)hctx);
      R__b.ReadStaticArray((double*)htrans);
      R__b.ReadStaticArray((double*)hps);
      ...
      R__b.WriteArray((double*)hctx, 10);
      R__b.WriteArray(htrans, 2);
      R__b.WriteArray(hps, 2);
...
//______________________________________________________________________________
void BeamInfoSummary::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class BeamInfoSummary.
      TClass *R__cl = ::BeamInfoSummary::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nurun", &nurun);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "spill_flag", &spill_flag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "good_spill_flag", &good_spill_flag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "trg_sec", &trg_sec);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "spillnum", &spillnum);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nd280spillnum", &nd280spillnum);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "run_type", &run_type);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "target_eff[3]", target_eff);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "beam_time[5][9]", beam_time);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ct_np[5][9]", ct_np);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mumon[12]", mumon);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hct[3][5]", hct);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hctx[2][5]", hctx);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "htrans[2]", htrans);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hps[2]", hps);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "otr[13]", otr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "wohorn", &wohorn);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "horn1", &horn1);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "whorn", &whorn);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "cutwotr", &cutwotr);
...
namespace ROOT {
   ...
   static void streamer_BeamInfoSummary(TBuffer &buf, void *obj) {
      ((::BeamInfoSummary*)obj)->::BeamInfoSummary::Streamer(buf);
   }
...
extern "C" void G__set_cpp_environmentBeamInfoSummaryDict() {
  ...
  G__add_compiledheader("../src/BeamInfoSummary.h");
...
/* BeamInfoSummary */
static int G__BeamInfoSummaryDict_198_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_198_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   BeamInfoSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__BeamInfoSummaryDict_198_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_198_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) BeamInfoSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_198_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_198_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) BeamInfoSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_198_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_198_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_198_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_198_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) BeamInfoSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_198_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_198_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_198_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BeamInfoSummaryDict_198_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableBeamInfoSummaryDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TVirtualArray*>",117,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,std::ptrdiff_t,const TObject**,const TObject*&>",117,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarBeamInfoSummary(void) {
   ...
   G__memvar_setup((void*)((long)(&p->hctx)-(long)(p)),100,0,0,-1,G__defined_typename("Double_t"),-1,1,"hctx[2][5]=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->htrans)-(long)(p)),100,0,0,-1,G__defined_typename("Double_t"),-1,1,"htrans[2]=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->hps)-(long)(p)),100,0,0,-1,G__defined_typename("Double_t"),-1,1,"hps[2]=",0,(char*)NULL);
...
static void G__setup_memfuncBeamInfoSummary(void) {
   ...
   G__memfunc_setup("BeamInfoSummary",1519,G__BeamInfoSummaryDict_198_0_1, 105, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BeamInfoSummary",1519,G__BeamInfoSummaryDict_198_0_2, 105, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 0, 1, 1, 1, 0, "u 'BeamInfoSummary' - 11 - info", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__BeamInfoSummaryDict_198_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__BeamInfoSummaryDict_198_0_5, 85, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&BeamInfoSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__BeamInfoSummaryDict_198_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BeamInfoSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__BeamInfoSummaryDict_198_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&BeamInfoSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__BeamInfoSummaryDict_198_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&BeamInfoSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__BeamInfoSummaryDict_198_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__BeamInfoSummaryDict_198_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BeamInfoSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__BeamInfoSummaryDict_198_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BeamInfoSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__BeamInfoSummaryDict_198_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BeamInfoSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__BeamInfoSummaryDict_198_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BeamInfoSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~BeamInfoSummary", 1645, G__BeamInfoSummaryDict_198_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BeamInfoSummaryDict_198_0_18, (int) ('u'), G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 1, 1, 1, 1, 0, "u 'BeamInfoSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__BeamInfoSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR = { "vector<TVirtualArray*,allocator<TVirtualArray*> >" , 99 , -1 };
G__linked_taginfo G__BeamInfoSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TVirtualArray*,allocator<TVirtualArray*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableBeamInfoSummaryDict() {
  ...
  G__BeamInfoSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR.tagnum = -1 ;
  G__BeamInfoSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableBeamInfoSummaryDict() {
   ...
   G__get_linked_tagnum_fwd(&G__BeamInfoSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR);
   G__get_linked_tagnum_fwd(&G__BeamInfoSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__BeamInfoSummaryDictLN_BeamInfoSummary),sizeof(BeamInfoSummary),-1,30464,"Beam Info Summary",G__setup_memvarBeamInfoSummary,G__setup_memfuncBeamInfoSummary);
}
