//
// File generated by rootcint at Fri Apr 14 19:13:30 2017

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME IngridHitSummaryDict
...
namespace ROOT {
   void IngridHitSummary_ShowMembers(void *obj, TMemberInspector &R__insp);
   ...
   static void streamer_IngridHitSummary(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridHitSummary*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("IngridHitSummary", ::IngridHitSummary::Class_Version(), "./../src/IngridHitSummary.h", 16,
      ...
      instance.SetStreamerFunc(&streamer_IngridHitSummary);
      return &instance;
   }
...
//______________________________________________________________________________
void IngridHitSummary::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "cyc", &cyc);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "view", &view);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pln", &pln);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ch", &ch);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "adc", &adc);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "loadc", &loadc);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pe", &pe);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "lope", &lope);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pecorr", &pecorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vise", &vise);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "visecorr", &visecorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "tdc", &tdc);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "time", &time);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "tnearhit", &tnearhit);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "timecorr", &timecorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "xy", &xy);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "z", &z);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "addbasicrecon", &addbasicrecon);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "dummy", &dummy);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gocosmic", &gocosmic);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hitcosmic", &hitcosmic);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "isohit", &isohit);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gridcell_id_x1", &gridcell_id_x1);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gridcell_id_x2", &gridcell_id_x2);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gridcell_id_y1", &gridcell_id_y1);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "gridcell_id_y2", &gridcell_id_y2);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "pe_cross", &pe_cross);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nsimhits", &nsimhits);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fIngridSimHit[1]", fIngridSimHit);
...
namespace ROOT {
   ...
   static void streamer_IngridHitSummary(TBuffer &buf, void *obj) {
      ((::IngridHitSummary*)obj)->::IngridHitSummary::Streamer(buf);
   }
...
extern "C" void G__set_cpp_environmentIngridHitSummaryDict() {
  ...
  G__add_compiledheader("../src/IngridHitSummary.h");
...
/* IngridHitSummary */
static int G__IngridHitSummaryDict_199_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_199_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   IngridHitSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__IngridHitSummaryDict_199_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_199_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((IngridHitSummary*) G__getstructoffset())->Pe());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridHitSummary*) G__getstructoffset())->NSimHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_199_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridHitSummary*) G__getstructoffset())->GetIngridSimHit((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridHitSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridHitSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_199_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_199_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridHitSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_199_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_199_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridHitSummaryDict_199_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableIngridHitSummaryDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TVirtualArray*>",117,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,std::ptrdiff_t,const TObject**,const TObject*&>",117,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarIngridHitSummary(void) {
   ...
   G__memvar_setup((void*)((long)(&p->gridcell_id_x1)-(long)(p)),105,0,0,-1,-1,-1,1,"gridcell_id_x1=",0,"for cross talk study 2016/1/13");
   G__memvar_setup((void*)((long)(&p->gridcell_id_x2)-(long)(p)),105,0,0,-1,-1,-1,1,"gridcell_id_x2=",0,"for cross talk study 2016/1/13");
   G__memvar_setup((void*)((long)(&p->gridcell_id_y1)-(long)(p)),105,0,0,-1,-1,-1,1,"gridcell_id_y1=",0,"for cross talk study 2016/1/13");
   G__memvar_setup((void*)((long)(&p->gridcell_id_y2)-(long)(p)),105,0,0,-1,-1,-1,1,"gridcell_id_y2=",0,"for cross talk study 2016/1/13");
   G__memvar_setup((void*)((long)(&p->pe_cross)-(long)(p)),102,0,0,-1,-1,-1,1,"pe_cross=",0,"for cross talk study 2016/1/13");
...
static void G__setup_memfuncIngridHitSummary(void) {
   ...
   G__memfunc_setup("IngridHitSummary",1648,G__IngridHitSummaryDict_199_0_1, 105, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IngridHitSummary",1648,G__IngridHitSummaryDict_199_0_2, 105, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 0, 1, 1, 1, 0, "u 'IngridHitSummary' - 11 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridHitSummaryDict_199_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Pe",181,G__IngridHitSummaryDict_199_0_5, 102, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimHits",783,G__IngridHitSummaryDict_199_0_6, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridSimHit",1460,G__IngridHitSummaryDict_199_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridSimHitSummary' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridSimHit",1483,G__IngridHitSummaryDict_199_0_8, 85, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridSimHitSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridHitSummaryDict_199_0_9, 85, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&IngridHitSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__IngridHitSummaryDict_199_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridHitSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridHitSummaryDict_199_0_11, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&IngridHitSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridHitSummaryDict_199_0_12, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&IngridHitSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridHitSummaryDict_199_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridHitSummaryDict_199_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridHitSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridHitSummaryDict_199_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridHitSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridHitSummaryDict_199_0_19, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridHitSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridHitSummaryDict_199_0_20, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridHitSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~IngridHitSummary", 1774, G__IngridHitSummaryDict_199_0_21, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridHitSummaryDict_199_0_22, (int) ('u'), G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 1, 1, 1, 1, 0, "u 'IngridHitSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__IngridHitSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR = { "vector<TVirtualArray*,allocator<TVirtualArray*> >" , 99 , -1 };
G__linked_taginfo G__IngridHitSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TVirtualArray*,allocator<TVirtualArray*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableIngridHitSummaryDict() {
  ...
  G__IngridHitSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR.tagnum = -1 ;
  G__IngridHitSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableIngridHitSummaryDict() {
   ...
   G__get_linked_tagnum_fwd(&G__IngridHitSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR);
   G__get_linked_tagnum_fwd(&G__IngridHitSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__IngridHitSummaryDictLN_IngridHitSummary),sizeof(IngridHitSummary),-1,30464,"Ingrid Hit Summary",G__setup_memvarIngridHitSummary,G__setup_memfuncIngridHitSummary);
}
