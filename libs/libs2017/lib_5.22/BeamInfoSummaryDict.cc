//
// File generated by rootcint at Fri Apr 14 19:16:03 2017
...
void BeamInfoSummary::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
      ...
      R__insp.Inspect(R__cl, R__parent, "hctx[2][5]", hctx);
      R__insp.Inspect(R__cl, R__parent, "htrans[2]", htrans);
      R__insp.Inspect(R__cl, R__parent, "hps[2]", hps);
...
static int G__BeamInfoSummaryDict_173_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncBeamInfoSummary(void) {
   ...
   G__memfunc_setup("Print",525,G__BeamInfoSummaryDict_173_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
