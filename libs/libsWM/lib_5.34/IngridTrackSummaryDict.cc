//
// File generated by rootcint at Mon Jan 16 19:48:21 2017

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME IngridTrackSummaryDict
...
namespace ROOT {
   void IngridTrackSummary_ShowMembers(void *obj, TMemberInspector &R__insp);
   ...
   static void streamer_IngridTrackSummary(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridTrackSummary*)
   {
      ...
      instance.SetStreamerFunc(&streamer_IngridTrackSummary);
      return &instance;
   }
...
//______________________________________________________________________________
void IngridTrackSummary::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class IngridTrackSummary.
      TClass *R__cl = ::IngridTrackSummary::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vtxi[3]", vtxi);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vtxf[3]", vtxf);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "covx", &covx);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "covy", &covy);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "chi2x", &chi2x);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "chi2y", &chi2y);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "btheta", &btheta);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "bphi", &bphi);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mrdhitid[2]", mrdhitid);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "mucl", &mucl);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nsimemshowers", &nsimemshowers);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fIngridHit[1000]", fIngridHit);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fSimParticle[10]", fSimParticle);
...
namespace ROOT {
   ...
   static void streamer_IngridTrackSummary(TBuffer &buf, void *obj) {
      ((::IngridTrackSummary*)obj)->::IngridTrackSummary::Streamer(buf);
   }
...
/* IngridTrackSummary */
static int G__IngridTrackSummaryDict_201_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   IngridTrackSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__IngridTrackSummaryDict_201_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridTrackSummary*) G__getstructoffset())->NHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridTrackSummary*) G__getstructoffset())->NSimParticles());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridTrackSummary*) G__getstructoffset())->NSimEMShowers());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridTrackSummary*) G__getstructoffset())->GetIngridHit((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridTrackSummary*) G__getstructoffset())->GetSimParticle((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridTrackSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridTrackSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridTrackSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridTrackSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridTrackSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridTrackSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_201_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_201_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridTrackSummaryDict_201_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableIngridTrackSummaryDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TVirtualArray*>",117,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,std::ptrdiff_t,const TObject**,const TObject*&>",117,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memfuncIngridTrackSummary(void) {
   ...
   G__memfunc_setup("IngridTrackSummary",1856,G__IngridTrackSummaryDict_201_0_1, 105, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridTrackSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IngridTrackSummary",1856,G__IngridTrackSummaryDict_201_0_2, 105, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridTrackSummary), -1, 0, 1, 1, 1, 0, "u 'IngridTrackSummary' - 11 - trk", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridTrackSummaryDict_201_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NHits",486,G__IngridTrackSummaryDict_201_0_5, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimParticles",1310,G__IngridTrackSummaryDict_201_0_6, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimEMShowers",1268,G__IngridTrackSummaryDict_201_0_7, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridHit",1163,G__IngridTrackSummaryDict_201_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridHitSummary' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridHit",1186,G__IngridTrackSummaryDict_201_0_9, 85, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridHitSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddSimParticle",1382,G__IngridTrackSummaryDict_201_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridSimParticleSummary' - 0 - part", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSimParticle",1405,G__IngridTrackSummaryDict_201_0_11, 85, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridSimParticleSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridTrackSummaryDict_201_0_12, 85, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&IngridTrackSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__IngridTrackSummaryDict_201_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridTrackSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridTrackSummaryDict_201_0_14, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&IngridTrackSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridTrackSummaryDict_201_0_15, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&IngridTrackSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridTrackSummaryDict_201_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridTrackSummaryDict_201_0_20, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridTrackSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridTrackSummaryDict_201_0_21, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridTrackSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridTrackSummaryDict_201_0_22, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridTrackSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridTrackSummaryDict_201_0_23, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridTrackSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~IngridTrackSummary", 1982, G__IngridTrackSummaryDict_201_0_24, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridTrackSummaryDict_201_0_25, (int) ('u'), G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridTrackSummary), -1, 1, 1, 1, 1, 0, "u 'IngridTrackSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__IngridTrackSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR = { "vector<TVirtualArray*,allocator<TVirtualArray*> >" , 99 , -1 };
G__linked_taginfo G__IngridTrackSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TVirtualArray*,allocator<TVirtualArray*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableIngridTrackSummaryDict() {
  ...
  G__IngridTrackSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR.tagnum = -1 ;
  G__IngridTrackSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableIngridTrackSummaryDict() {
   ...
   G__get_linked_tagnum_fwd(&G__IngridTrackSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR);
   G__get_linked_tagnum_fwd(&G__IngridTrackSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__IngridTrackSummaryDictLN_IngridTrackSummary),sizeof(IngridTrackSummary),-1,30464,"SciBar Track Summary",G__setup_memvarIngridTrackSummary,G__setup_memfuncIngridTrackSummary);
}
