...
public:
  ...
  void clear(){
    ...
    memset(hit_pln,-1,sizeof(hit_pln));
    memset(hit_ch,-1,sizeof(hit_ch));
    memset(hit_pe,-1.e-5,sizeof(hit_pe));
    memset(hit_lope,-1.e-5,sizeof(hit_lope));
    hit_n   =  -1;
  }
};
...
int view,pln[2][602],ch[2][602],pe[2][602],lope[2][602],hit[2],hitnum[2][18][32];
...
float hitpe[2][50][18];
int pid;
int hit_ch[2][500][100],hit_pln[2][500][100],hit_n[2][500];
float hit_pe[2][500][100],hit_lope[2][500][100];
