...
void fTrackMatch(Trk &trk, TrackPM &htrk, TrackPM &vtrk){
  ...
  initMuCL();
  //Benjamin addMuCL(htrk.hit,trkang,htrk.ipln,vtrk.intcpt,vtrk.slope);
  //Benjamin addMuCL(vtrk.hit,trkang,vtrk.ipln,htrk.intcpt,htrk.slope);
  //Benjamin trk.mucl=calcMuCL();
};
...
void fTrackMatchX(Trk &trk,PMTrack &pmtrk, TrackPM &htrk){
  ...
  //Benjamin initMuCL();
  //Benjamin addMuCL(htrk.hit,trkang,htrk.ipln,pmtrk.trk[0].intcpty,pmtrk.trk[0].slopey);
  //Benjamin trk.mucl=calcMuCL();
};
...
void fTrackMatchY(Trk &trk,PMTrack &pmtrk, TrackPM &vtrk){
  ...
  //Benjamin initMuCL();
  //Benjamin addMuCL(vtrk.hit,trkang,vtrk.ipln,pmtrk.trk[0].intcptx,pmtrk.trk[0].slopex);
  //Benjamin trk.mucl=calcMuCL();
};
