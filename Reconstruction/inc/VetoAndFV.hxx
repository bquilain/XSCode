...
bool fTracking(int mod, int VetoUpstreamCriteria, double VetoEdgeCriteria, double FVCriteria){
  ...
  //cout<<"VetoCriteria="<<VetoUpstreamCriteria<<", EdgeCriteria="<<VetoEdgeCriteria<<", FV="<<FVCriteria<<endl;
  ...
  for(int VIEW=0;VIEW<2;VIEW++){
    ...
    for(int TRA=0;TRA<ntrack[VIEW];TRA++){
      ...
      if(plane[VIEW][TRA][ntracl[VIEW][TRA]-1]<=VetoUpstreamCriteria){vetowtracking[VIEW][TRA]=true;}
