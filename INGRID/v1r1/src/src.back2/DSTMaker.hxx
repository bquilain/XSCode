...
void Book(Int_t run, Int_t subrun){
  char buff[300];
  if(!cosmic&&!PModule)
    sprintf(buff,"/home/daq/data/dst/ingrid_%08d_%04d.root",run,subrun);
  else if(cosmic&&!PModule)
    sprintf(buff,"/home/daq/data/cosmic/ingrid_%08d_%04d.root",run,subrun);
  else if(!cosmic&&PModule)
    sprintf(buff,"/home/daq/data/PM/ingrid_%08d_%04d.root",run,subrun);
  else if(cosmic&&PModule)
    sprintf(buff,"/home/daq/data/PM_cosmic/ingrid_%08d_%04d.root",run,subrun);
