...
*/
  ...
  if(!cosmic&&!PModule)
    sprintf(buff,"/home/bquilain/dst/ingrid_%08d_%04d.root",run,subrun);
  else if(cosmic&&!PModule)
    sprintf(buff,"/home/bquilain/cosmic/ingrid_%08d_%04d.root",run,subrun);
  else if(!cosmic&&PModule)
    sprintf(buff,"/home/bquilain/PM/ingrid_%08d_%04d.root",run,subrun);
  else if(cosmic&&PModule)
    sprintf(buff,"/home/bquilain/PM_cosmic/ingrid_%08d_%04d.root",run,subrun);
...
void ProcessFile(const char *FileName) {
  ...
  ND::TND280RawEvent* re;
  while (re = mf.ReadRawEvent()) {
