...
int main(int argc,char *argv[]){
  ...
  TH1D * Evt     = new TH1D("Evt","Evt by ADC",200,0,1000);
  double CI_ADC=0;
  ...
  */
  ...
  for(int ievt = 0; ievt < nevt; ++ievt){
	...
	//cout<<"Module:"<<mod<<"   , Cycle:"<<cyc<<endl;                                                                                              
	    ...
	    for(int i=0; i<ninghit; i++){
	      ...
	      if((LoGain[mod][view][pln][ch]<.1) && (inghitsum->adc-ped[mod][view][pln][ch]<100) && (inghitsum->adc-ped[mod][view][pln][ch])>value[mod][view][pln][ch]){
		LoGain[mod][view][pln][ch]=gain[mod][view][pln][ch]*(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->adc-ped[mod][view][pln][ch]);
  ...
  for(int ievt = 0; ievt < nevt; ++ievt){
	...
	//cout<<"Module:"<<mod<<"   , Cycle:"<<cyc<<endl;
	  ...
	  logain_corrected[mod][view][pln][ch]=LoGain[mod][view][pln][ch]*(Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc - loped[mod][view][pln][ch])/(inghitsum->loadc - loped[mod][view][pln][ch]))/(Gain_Cal_Lo[mod][view][pln][ch]);
 ...
 //logain_correction[mod][view][pln][ch]=(Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc - loped[mod][view][pln][ch])/(inghitsum->loadc - loped[mod][view][pln][ch]))/Gain_Cal_Lo[mod][view][pln][ch];
	  ...
	  */
	  ...
	  //#################################################
	    ...
	    double weight=gain_corrected[mod][view][pln][ch]/gain[mod][view][pln][ch];
	    if((gain[mod][view][pln][ch]!=0) && (TMath::Abs(weight)<1000))   {
  ...
  OldGain->SaveAs("oldgain.root");
  NewGain->SaveAs("newgain.root");
  GNL->Sumw2();
  GNL->Divide(Evt);
  GNL->SaveAs("gnl.root");
  wtree -> Write();
