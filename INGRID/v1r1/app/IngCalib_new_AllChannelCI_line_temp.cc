  ...
  */
  ...
  for(int ievt = 0; ievt < nevt; ++ievt){
	...
	//cout<<"Module:"<<mod<<"   , Cycle:"<<cyc<<endl;                                                                                              
	    ...
	    for(int i=0; i<ninghit; i++){
	      ...
	      if(CI_ADC==0) gain_correction[mod][view][pln][ch]=Gain_Cal[mod][view][pln][ch]/(Hi_Fit[mod][view][pln][ch]->Eval(700)/700);
	      else    gain_correction[mod][view][pln][ch]=Gain_Cal[mod][view][pln][ch]/(CI_ADC/(inghitsum->adc-ped[mod][view][pln][ch]));//R1/R2            
	      gain_corrected[mod][view][pln][ch]=gain[mod][view][pln][ch]*gain_correction[mod][view][pln][ch];
	      /*  if(TMath::Abs(gain_corrected[mod][view][pln][ch]-10)>7){
		cout<<"Module = "<<mod<<" , Plan = "<<pln<<" , Channel = "<<ch<<" , View = "<<view<<endl;
		cout<<"At Calibration Point, Slope was ="<<Gain_Cal[mod][view][pln][ch]<<" , gain was = "<<gain[mod][view][pln][ch]<<" , Slope Just Next this point is = "<<(Hi_Fit[mod][view][pln][ch]->Eval(gain[mod][view][pln][ch]+5)/(gain[mod][view][pln][ch]+5))<<endl;
		cout<<"At ADC Point, Slope is = "<<(CI_ADC/(inghitsum->adc-ped[mod][view][pln][ch]))<<" , gain corrected is = "<<gain_corrected[mod][view][pln][ch]<<" , Slope Just Next this point is = "<<(Hi_Fit[mod][view][pln][ch]->Eval(inghitsum->adc-ped[mod][view][pln][ch]+10)/(inghitsum->adc-ped[mod][view][pln][ch]+10))<<endl;
		cout<<"ND280 CI Curves to check is = "<<NDChan[mod][view][pln][ch]<<endl<<endl;
		}*/
	      //if(gain_corrected[mod][view][pln][ch]>100) gain_corrected[mod][view][pln][ch]=gain[mod][view][pln][ch];//TO CHANGE AFTER
		...
		gain_cal[mod][view][pln][ch] +=gain[mod][view][pln][ch];
		NPoints[mod][view][pln][ch]++;
		NHiADC[mod][view][pln][ch]+=inghitsum->adc-ped[mod][view][pln][ch];
		//NLoADC[mod][view][pln][ch]+=inghitsum->loadc-loped[mod][view][pln][ch];
	      }

	      double HighPE=(inghitsum->adc-ped[mod][view][pln][ch])/gain_corrected[mod][view][pln][ch];

	      /* if((gain[mod][view][pln][ch]<20) && (Gain_Cal[mod][view][pln][ch] <1.7) && (TMath::Abs(gain_corrected[mod][view][pln][ch]*(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->adc-ped[mod][view][pln][ch])-1)>1.7)){
		cout<<"High Gain Corrected = "<<gain_corrected[mod][view][pln][ch]<<" , Amount of Low ADC = "<<inghitsum->loadc-loped[mod][view][pln][ch]<<" , Amount of High ADC = "<<inghitsum->adc-ped[mod][view][pln][ch]<<endl<<endl;
		}*/
	      if((gain[mod][view][pln][ch]<20) && (Gain_Cal[mod][view][pln][ch] <1.7)){

	      if((HighPE<10) && (HighPE)>6){
		...
		LoGain[mod][view][pln][ch]+=gain_corrected[mod][view][pln][ch]*(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->adc-ped[mod][view][pln][ch]);
		NPoints2[mod][view][pln][ch]++;
		//value[mod][view][pln][ch]=inghitsum->adc-ped[mod][view][pln][ch];
		//toeactiveifpoint
		Gain_Cal_Lo[mod][view][pln][ch]=Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->loadc-loped[mod][view][pln][ch]);
		NLoADC[mod][view][pln][ch]+=inghitsum->loadc-loped[mod][view][pln][ch];
		}

	      if((HighPE<10) && (HighPE>value[mod][view][pln][ch])){
		value[mod][view][pln][ch]=inghitsum->adc-ped[mod][view][pln][ch];
		LoGain2[mod][view][pln][ch]=gain_corrected[mod][view][pln][ch]*(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->adc-ped[mod][view][pln][ch]);
		Gain_Cal_Lo[mod][view][pln][ch]=Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->loadc-loped[mod][view][pln][ch]);
	      }
	      if(TMath::Abs(Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->loadc-loped[mod][view][pln][ch])-10)>5 && ((mod<16 && pln<11)||(mod==16 && pln<18)) && (inghitsum->loadc-loped[mod][view][pln][ch]>.01)){
		cout<<"Module = "<<mod<<" , Plan = "<<pln<<" , Channel = "<<ch<<" , View = "<<view<<endl;
		cout<<"Slope of the LoGain Chan = "<< Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc-loped[mod][view][pln][ch])/(inghitsum->loadc-loped[mod][view][pln][ch])<<" , CI Value = "<<Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc-loped[mod][view][pln][ch])<<" Low ADC Value = "<<(inghitsum->loadc-loped[mod][view][pln][ch])<<endl;
		cout<<"ND280 CI Curves to check is = "<<NDChan[mod][view][pln][ch]<<endl<<endl;
  ...
  for(int mod=0;mod<nMod;mod++){
	...
	for(int ch=0;ch<nCh;ch++){
	  ...
	  if(NPoints[mod][view][pln][ch]==0) {gain_cal[mod][view][pln][ch]=gain[mod][view][pln][ch];}
	  else {
	    gain_cal[mod][view][pln][ch] /= NPoints[mod][view][pln][ch];
	    NHiADC[mod][view][pln][ch] /= NPoints[mod][view][pln][ch];
	    Gain_Cal[mod][view][pln][ch]=Hi_Fit[mod][view][pln][ch]->Eval(NHiADC[mod][view][pln][ch])/(NHiADC[mod][view][pln][ch]);
	  }
	  //if(NPoints2[mod][view][pln][ch]==0) {LoGain[mod][view][pln][ch]=logain[mod][view][pln][ch];}
	  if(NPoints2[mod][view][pln][ch]<=2) {
	    if(value[mod][view][pln][ch]<=20) {LoGain[mod][view][pln][ch]=logain[mod][view][pln][ch];}
	      else LoGain[mod][view][pln][ch]=LoGain2[mod][view][pln][ch];
	  }
	  else {
	    LoGain[mod][view][pln][ch] /= NPoints2[mod][view][pln][ch];
	    //NLoADC[mod][view][pln][ch] /= NPoints[mod][view][pln][ch];
	    //LoGain[mod][view][pln][ch]=gain_cal[mod][view][pln][ch]*(NLoADC[mod][view][pln][ch])/(NLoADC[mod][view][pln][ch]);
	    Gain_Cal_Lo[mod][view][pln][ch]=Lo_Fit[mod][view][pln][ch]->Eval(NLoADC[mod][view][pln][ch])/(NLoADC[mod][view][pln][ch]);
	    }
  ...
  for(int ievt = 0; ievt < nevt; ++ievt){
	...
	//cout<<"Module:"<<mod<<"   , Cycle:"<<cyc<<endl;
	  ...
	  //gain_corrected[mod][view][pln][ch]=gain_cal[mod][view][pln][ch]*(Gain_Cal[mod][view][pln][ch])/(Hi_Fit[mod][view][pln][ch]->Eval(inghitsum->adc - ped[mod][view][pln][ch])/(inghitsum->adc - ped[mod][view][pln][ch]));
	  //if(gain[mod][view][pln][ch]>20) gain_corrected[mod][view][pln][ch]=gain[mod][view][pln][ch];
	  ...
	  //if(TMath::Abs(LoGain[mod][view][pln][ch]-1)>.4) LoGain[mod][view][pln][ch]=logain[mod][view][pln][ch];
	  ...
	  //if(logain_corrected[mod][view][pln][ch]>10) logain_corrected[mod][view][pln][ch]=logain[mod][view][pln][ch];
 ...
 //logain_correction[mod][view][pln][ch]=(Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc - loped[mod][view][pln][ch])/(inghitsum->loadc - loped[mod][view][pln][ch]))/Gain_Cal_Lo[mod][view][pln][ch];
	  ...
	  */
	  ...
	  //#################################################
	    ...
	    if(((mod<16 && pln<11)||(mod==16 && pln<18)) && (gain_corrected[mod][view][pln][ch]!=0) && (logain_corrected[mod][view][pln][ch]!=0) && (Hipe>.1) && (Lope>.1) && (gain[mod][view][pln][ch]<20) && Gain_Cal[mod][view][pln][ch]<1.7/*&& (Hipe<1000) && (Lope<1000)*/) {//éviter les fails = pas top a corriger ensuite en dur dans le code
