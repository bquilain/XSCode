	  ...
	  */
	  ...
	  if( GoodCh[mod][view][pln][ch] ){//forcement assure car on parcourt les évenements
	    if(TMath::Abs(gain[mod][view][pln][ch]-10.)<5. && (Gain_Cal[mod][view][pln][ch] <1.5)){
	      ...
	      //double HGCorr=Hi_Fit[mod][view][pln][ch]->Eval(inghitsum->adc - ped[mod][view][pln][ch])*CI2PE[mod][view][pln][ch];
	      
	      //cout<<HGCorr<<endl;
              int LLine=inghitsum->loadc - loped[mod][view][pln][ch];
              //double LGCorr=Lo_Fit[mod][view][pln][ch]->Eval(inghitsum->loadc - loped[mod][view][pln][ch])*CI2PE[mod][view][pln][ch];
