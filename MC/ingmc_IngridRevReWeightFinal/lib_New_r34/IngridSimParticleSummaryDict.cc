//
// File generated by rootcint at Wed Dec 14 13:03:14 2016

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME IngridSimParticleSummaryDict
...
namespace ROOT {
   void IngridSimParticleSummary_ShowMembers(void *obj, TMemberInspector &R__insp);
   ...
   static void streamer_IngridSimParticleSummary(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridSimParticleSummary*)
   {
      ...
      instance.SetStreamerFunc(&streamer_IngridSimParticleSummary);
      return &instance;
   }
...
//______________________________________________________________________________
void IngridSimParticleSummary::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "momentum[4]", momentum);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ipos[4]", ipos);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fpos[4]", fpos);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "iposflag", &iposflag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fposflag", &fposflag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "dir[3]", dir);
...
namespace ROOT {
   ...
   static void streamer_IngridSimParticleSummary(TBuffer &buf, void *obj) {
      ((::IngridSimParticleSummary*)obj)->::IngridSimParticleSummary::Streamer(buf);
   }
...
static int G__IngridSimParticleSummaryDict_168_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridSimParticleSummaryDict_168_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridSimParticleSummaryDict_168_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridSimParticleSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridSimParticleSummaryDict_168_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridSimParticleSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridSimParticleSummaryDict_168_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridSimParticleSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridSimParticleSummaryDict_168_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridSimParticleSummaryDict_168_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridSimParticleSummaryDict_168_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridSimParticleSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridSimParticleSummaryDict_168_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridSimParticleSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridSimParticleSummaryDict_168_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridSimParticleSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridSimParticleSummaryDict_168_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridSimParticleSummaryDict_168_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__IngridSimParticleSummaryDict_168_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridSimParticleSummaryDict_168_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableIngridSimParticleSummaryDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TVirtualArray*>",117,G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memfuncIngridSimParticleSummary(void) {
   ...
   G__memfunc_setup("IngridSimParticleSummary",2472,G__IngridSimParticleSummaryDict_168_0_1, 105, G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_IngridSimParticleSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridSimParticleSummaryDict_168_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridSimParticleSummaryDict_168_0_4, 85, G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&IngridSimParticleSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__IngridSimParticleSummaryDict_168_0_5, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridSimParticleSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridSimParticleSummaryDict_168_0_6, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&IngridSimParticleSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridSimParticleSummaryDict_168_0_7, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&IngridSimParticleSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridSimParticleSummaryDict_168_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridSimParticleSummaryDict_168_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridSimParticleSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridSimParticleSummaryDict_168_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridSimParticleSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridSimParticleSummaryDict_168_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridSimParticleSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridSimParticleSummaryDict_168_0_15, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridSimParticleSummary::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("IngridSimParticleSummary", 2472, G__IngridSimParticleSummaryDict_168_0_16, (int) ('i'), 
G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_IngridSimParticleSummary), -1, 0, 1, 1, 1, 0, "u 'IngridSimParticleSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~IngridSimParticleSummary", 2598, G__IngridSimParticleSummaryDict_168_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridSimParticleSummaryDict_168_0_18, (int) ('u'), G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_IngridSimParticleSummary), -1, 1, 1, 1, 1, 0, "u 'IngridSimParticleSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__IngridSimParticleSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR = { "vector<TVirtualArray*,allocator<TVirtualArray*> >" , 99 , -1 };
G__linked_taginfo G__IngridSimParticleSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TVirtualArray*,allocator<TVirtualArray*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableIngridSimParticleSummaryDict() {
  ...
  G__IngridSimParticleSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR.tagnum = -1 ;
  G__IngridSimParticleSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableIngridSimParticleSummaryDict() {
   ...
   G__get_linked_tagnum_fwd(&G__IngridSimParticleSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR);
   G__get_linked_tagnum_fwd(&G__IngridSimParticleSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR);
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__IngridSimParticleSummaryDictLN_IngridSimParticleSummary),sizeof(IngridSimParticleSummary),-1,29952,"Simulation (detector mc) particle Summary",G__setup_memvarIngridSimParticleSummary,G__setup_memfuncIngridSimParticleSummary);
}
