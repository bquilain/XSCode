//
// File generated by rootcint at Sun Aug 30 10:14:13 2015

// Do NOT change. Changes will be lost next time file is generated
//

#define R__DICTIONARY_FILENAME IngridBasicReconSummaryDict
...
namespace ROOT {
   void IngridBasicReconSummary_ShowMembers(void *obj, TMemberInspector &R__insp);
   ...
   static void streamer_IngridBasicReconSummary(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridBasicReconSummary*)
   {
      ...
      instance.SetStreamerFunc(&streamer_IngridBasicReconSummary);
      return &instance;
   }
...
//______________________________________________________________________________
void IngridBasicReconSummary::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "CTtimecorr", &CTtimecorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "clstimecorr", &clstimecorr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "exptime", &exptime);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nhitclster", &nhitclster);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nactpln", &nactpln);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "actinarow", &actinarow);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "layerpe", &layerpe);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "upstreamVETO", &upstreamVETO);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "upstreamedge", &upstreamedge);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "newfid", &newfid);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "newfidcosmic", &newfidcosmic);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vinternal", &vinternal);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hitmod", &hitmod);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hitcyc", &hitcyc);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "spill_flag", &spill_flag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "bunch_flag", &bunch_flag);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ontime", &ontime);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "trgbit", &trgbit);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "inarowbit", &inarowbit);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vetodist", &vetodist);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "hastrk", &hastrk);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "matchtrk", &matchtrk);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "modfc", &modfc);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "penIron", &penIron);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "muE", &muE);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nuErec", &nuErec);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nhitx", &nhitx);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nhity", &nhity);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ntrackhitx", &ntrackhitx);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ntrackhity", &ntrackhity);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "retracktest", &retracktest);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "trg_sec", &trg_sec);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "upstreamtpl", &upstreamtpl);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexz", &vertexz);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexxz", &vertexxz);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexyz", &vertexyz);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "angle", &angle);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "thetax", &thetax);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "thetay", &thetay);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexx", (void*)&vertexx);
      R__insp.InspectMember("vector<int>", (void*)&vertexx, "vertexx.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexy", (void*)&vertexy);
      R__insp.InspectMember("vector<int>", (void*)&vertexy, "vertexy.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "horn250", &horn250);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vpe", &vpe);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "startxpln", &startxpln);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "startypln", &startypln);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "startxch", &startxch);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "startych", &startych);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "endxpln", &endxpln);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "endypln", &endypln);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "endxch", &endxch);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "endych", &endych);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexx_true", &vertexx_true);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexy_true", &vertexy_true);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "vertexz_true", &vertexz_true);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "zx", &zx);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "zy", &zy);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "bye", &bye);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nhits", &nhits);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nhitTs[100]", nhitTs);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fIngridHit[1000]", fIngridHit);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fIngridHitTrk[1000][100]", fIngridHitTrk);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "fTrack[100]", fTrack);
...
namespace ROOT {
   ...
   static void streamer_IngridBasicReconSummary(TBuffer &buf, void *obj) {
      ((::IngridBasicReconSummary*)obj)->::IngridBasicReconSummary::Streamer(buf);
   }
...
static int G__IngridBasicReconSummaryDict_203_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   IngridBasicReconSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__IngridBasicReconSummaryDict_203_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridBasicReconSummary*) G__getstructoffset())->GetIngridHit((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((IngridBasicReconSummary*) G__getstructoffset())->AddIngridHitTrk((IngridHitSummary*) G__int(libp->para[0]), (int) G__int(libp->para[1]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridBasicReconSummary*) G__getstructoffset())->GetIngridHitTrk((int) G__int(libp->para[0]), (int) G__int(libp->para[1])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridBasicReconSummary*) G__getstructoffset())->GetTrack((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((IngridBasicReconSummary*) G__getstructoffset())->Nhits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((IngridBasicReconSummary*) G__getstructoffset())->NhitTs((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((IngridBasicReconSummary*) G__getstructoffset())->Ntracks());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridBasicReconSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridBasicReconSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridBasicReconSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridBasicReconSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridBasicReconSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridBasicReconSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridBasicReconSummaryDict_203_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridBasicReconSummaryDict_203_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridBasicReconSummaryDict_203_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableIngridBasicReconSummaryDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TVirtualArray*>",117,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR));
   G__setnewtype(-1,NULL,0);
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,std::ptrdiff_t,const TObject**,const TObject*&>",117,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarIngridBasicReconSummary(void) {
   ...
   G__memvar_setup((void*)((long)(&p->bye)-(long)(p)),102,0,0,-1,-1,-1,1,"bye=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->nhits)-(long)(p)),105,0,0,-1,-1,-1,1,"nhits=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->nhitTs)-(long)(p)),105,0,0,-1,-1,-1,1,"nhitTs[100]=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_TRef),-1,-1,4,"fIngridHitTrk[1000][100]=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_TRef),-1,-1,4,"fTrack[100]=",0,(char*)NULL);
...
static void G__setup_memfuncIngridBasicReconSummary(void) {
   ...
   G__memfunc_setup("IngridBasicReconSummary",2340,G__IngridBasicReconSummaryDict_203_0_1, 105, G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_IngridBasicReconSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IngridBasicReconSummary",2340,G__IngridBasicReconSummaryDict_203_0_2, 105, G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_IngridBasicReconSummary), -1, 0, 1, 1, 1, 0, "u 'IngridBasicReconSummary' - 11 - basicsum", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridBasicReconSummaryDict_203_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridHit",1163,G__IngridBasicReconSummaryDict_203_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridHitSummary' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridHit",1186,G__IngridBasicReconSummaryDict_203_0_6, 85, G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_IngridHitSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridHitTrk",1468,G__IngridBasicReconSummaryDict_203_0_7, 121, -1, -1, 0, 2, 1, 1, 0, 
"U 'IngridHitSummary' - 0 - hit i - - 0 - track", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridHitTrk",1491,G__IngridBasicReconSummaryDict_203_0_8, 85, G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_IngridHitSummary), -1, 0, 2, 1, 1, 8, 
"i - - 0 - i i - - 0 - track", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddTrack",766,G__IngridBasicReconSummaryDict_203_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridTrackSummary' - 0 - trk", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTrack",789,G__IngridBasicReconSummaryDict_203_0_10, 85, G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_IngridTrackSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Nhits",518,G__IngridBasicReconSummaryDict_203_0_11, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NhitTs",602,G__IngridBasicReconSummaryDict_203_0_12, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - trk", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Ntracks",726,G__IngridBasicReconSummaryDict_203_0_13, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridBasicReconSummaryDict_203_0_14, 85, G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&IngridBasicReconSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__IngridBasicReconSummaryDict_203_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridBasicReconSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridBasicReconSummaryDict_203_0_16, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&IngridBasicReconSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridBasicReconSummaryDict_203_0_17, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&IngridBasicReconSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridBasicReconSummaryDict_203_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridBasicReconSummaryDict_203_0_22, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridBasicReconSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridBasicReconSummaryDict_203_0_23, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridBasicReconSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridBasicReconSummaryDict_203_0_24, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridBasicReconSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridBasicReconSummaryDict_203_0_25, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridBasicReconSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~IngridBasicReconSummary", 2466, G__IngridBasicReconSummaryDict_203_0_26, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridBasicReconSummaryDict_203_0_27, (int) ('u'), G__get_linked_tagnum(&G__IngridBasicReconSummaryDictLN_IngridBasicReconSummary), -1, 1, 1, 1, 1, 0, "u 'IngridBasicReconSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__IngridBasicReconSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR = { "vector<TVirtualArray*,allocator<TVirtualArray*> >" , 99 , -1 };
G__linked_taginfo G__IngridBasicReconSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TVirtualArray*,allocator<TVirtualArray*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableIngridBasicReconSummaryDict() {
  ...
  G__IngridBasicReconSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR.tagnum = -1 ;
  G__IngridBasicReconSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableIngridBasicReconSummaryDict() {
   ...
   G__get_linked_tagnum_fwd(&G__IngridBasicReconSummaryDictLN_vectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgR);
   G__get_linked_tagnum_fwd(&G__IngridBasicReconSummaryDictLN_reverse_iteratorlEvectorlETVirtualArraymUcOallocatorlETVirtualArraymUgRsPgRcLcLiteratorgR);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__IngridBasicReconSummaryDictLN_IngridBasicReconSummary),sizeof(IngridBasicReconSummary),-1,30464,"Ingrid Hit Summary",G__setup_memvarIngridBasicReconSummary,G__setup_memfuncIngridBasicReconSummary);
