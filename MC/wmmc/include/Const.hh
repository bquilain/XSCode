...
const double CTargetX = 100.0;//cm
...
const double CWagaboxsideZ = 1.51;//m
//upstream VETO
...
const double CWagaboxsideposZ = -1.;//m
//upstream VETO
...
const int latice_plnNum     = 32;   //2014/6/11
...
//proto type
const double loli_startz=-300;
/////copy const double loli_ajustz=-9.5;
////////////////////////////////////////////////////////////////
...
const double CStartmod2_sci_v = -150; //cm
